...
<ol class="breadcrumb">
	...
	<li class="active">Modification d'un outil existant</li>
</ol>
...
<form action="dashboard.jsp?page=manageItems"
			...
			<div class="col-sm-6">
				<select class="form-control" id="itemCategory" name="itemCategory"
					...
					%>
						...
						<% } else { %>
							<option selected="selected" value="<%=c.getId()%>"><%=c.getNom()%></option>
						<% }
					} %>
				</select> <br />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<textarea class="form-control" rows="5" id="itemDetails"
					name="itemDetails" required><%=toolToUpdate.getDescription() %></textarea>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" class="form-control" maxlength="4"
					id="itemCaution" name="itemCaution" value="<%=toolToUpdate.getCaution() %>" required />
			</div>
			...
			<div class="col-sm-6" id="datepicker">
				...
				<div class="input-daterange input-group" id="datepicker">
					<span class="input-group-addon">du </span> <input type="text"
						...
						name="start" value="<%=dateDeb %>" required /> <span class="input-group-addon">
