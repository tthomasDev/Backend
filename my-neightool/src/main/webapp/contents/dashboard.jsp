...
%>
		<div class="col-md-3 well">
			...
			<div class="col-md-9">
					...
					<table class="table table-hover" id="toReorder">
						<thead>
							<tr>
								...
								<th style="text-align:center;" width="20%">Distance <a href="javascript:void(0);" onclick="reorderBy('asc','distance');"><span class="glyphicon glyphicon-chevron-up"></span></a><a href="javascript:void(0);" onclick="reorderBy('desc','distance');"><span class="glyphicon glyphicon-chevron-down"></span></a></th>
							</tr>
						</thead>
						<tbody>
				...
				<input type="hidden" readonly="readonly" name="paginatorNbElements" value="5" />
			</div>
